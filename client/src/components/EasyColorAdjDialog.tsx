/**
 * EasyColorAdjDialog — per-job Easy Color Adjustments dialog
 * Right-click job → "Easy Color Adjustments" opens this 3-tab dialog
 * Tabs: Color Adjust | Processing Options | Ink Removal
 * Exact DFv12 EasyColorAdj dialog
 */
...
export default function EasyColorAdjDialog({ job, onClose, onApply }: Props) {
  // ── Color Adjust tab ──────────────────────────────────────────────────────
    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          <div>
            <h2 className="text-sm font-semibold text-foreground">Easy Color Adjustments</h2>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[9px] text-muted-foreground/60">
                  Adds regular holes/stripes to reduce ink usage (Forever Dark Transfer style)
                </p>
              </div>
