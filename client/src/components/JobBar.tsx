/**
 * Manhattan RIP X — Smart Bar
 *
 * Exact MRX Smart Bar layout (bottom-right panel):
 *
...
// MRX print mode presets for ET-8550
const PRINT_MODES = [
  "DTF Matte 1440×720 Best",
  "1440×720 Color Opaque",
  "1440×720 Best Quality",
  "720×720 Color Opaque",
  "720×360 Fast Draft",
  "1440×1440 High Detail",
  "2880×1440 Ultra Fine",
  "1440×720 DTG No-Raster",
  "Dark Film Transfer",
  "Dark Film w/ Holes",
  "Dark Film w/ Stripes",
];

export default function JobBar({ job, queue, onUpdate, onPrint, onOpenColorMgmt }: Props) {
